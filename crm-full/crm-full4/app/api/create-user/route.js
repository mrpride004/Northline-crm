...
export async function POST(request) {
  ...
  const { full_name, email, password, role, state, allowed_products } = await request.json();
  if (!full_name || !email || !password || !['staff', 'dispatch', 'manager', 'logistics', 'marketer'].includes(role)) {
